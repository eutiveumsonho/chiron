 ...
 *
 * @param {import("mongodb").Document} data The completion data to approve.
 ...
 *
 * @param {import("mongodb").Document} data The completion data to reject.
 * @returns {Promise<import("mongodb").InsertOneResult>}
 */
 ...
 *
 * @param {import("mongodb").Document} data The completion data to review
 ...
 *
 * @param {import("mongodb").Document} completionData Completion data to save
 * @returns {Promise<import("mongodb").InsertOneResult>}
 */
 ...
 *
 * @param {import("mongodb").Document} data The API key data to save.
 * @returns {Promise<import("mongodb").InsertOneResult>}
 */
